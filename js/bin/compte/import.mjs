...
export async function importLBPData(workbookHelp) {
    ...
    importRows.forEach(importRow => {
        const found = rows.some((row) => row && (importRow.date === row[0]) && (accountName === row[1]) && ((row[2] !== undefined) && (row[2].endsWith !== undefined) && (row[2].endsWith(importRow.label))) && (importRow.amount === row[3]));
        if (!found) {
