...
async function mailToPdf(options: OptionValues, message: any, outputDir: string, mboxPath: string) {
...
async function mboxToPdf(options: OptionValues, mboxPath: string, outputDir: string) {
